    ...
    var page = {
        ...
        initGird: function () {
            $('#girdtable').llAuthorizeJfGrid({
                ...
                headData: [
                        { label: '玩家称呼', name: 'nickName', width: 200, align: 'center' },
                        ...
                        {
                            label: ' 是否冻结', name: 'isFrozen', width: 80, align: 'center', sort: true, formatter: function (callback) {
                                if (callback == 1)
                       ...
                       {
                           label: ' 是否代理', name: 'isProxy', width: 80, align: 'center', sort: true, formatter: function (callback) {
                               if (callback == 1)
                                   return '<i class="fa fa-toggle-on"></i>';
                               else
                                   return '<i class="fa fa-toggle-off"></i>';
                        ...
                        { label: '登录时间', name: 'loginTime', width: 150, align: 'center', sort: true },
                        { label: '登录IP', name: 'loginIp', width: 150, align: 'center', formatter: function (callback, value, row) { return value.loginIp; } },
                        { label: '注册时间', name: 'registerTime', width: 150, align: 'center', sort: true },
