...
namespace Game.PC
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static MvcHtmlString GetModuleButtonList(this HtmlHelper htmlHelper)
        {
            ...
            BusinessLogic.SysManage.ISys_ModuleButton _but = new Game.DataAccess.SysManage.Sys_ModuleButtonDAL();
            IEnumerable<Game.Entity.SysManage.Sys_ModuleButton> buttonList = null;
            ...
            else
            {
                ...
                //查找 当前用户的权限->控件
                BusinessLogic.SysManage.ISys_Authorize _authorize = new Game.DataAccess.SysManage.Sys_AuthorizeDAL();
