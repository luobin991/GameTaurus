...
namespace Game.PC.Areas.AuthorizeModule.Controllers
{
    public class AuthorizeController : MvcControllerBase
    {
        ...
        public ActionResult SaveForm(string objectId, int objectType, string strModuleId, string strModuleButtonId, string strModuleColumnId)
        {
            ...
            this._authorize.SaveAuthorize(objectType,objectId, moduleIds, moduleButtonIds, moduleColumnIds,Game.PC.WebSecurityHelper.Passport.Current.UserId);
