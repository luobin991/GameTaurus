...
using Game.Entity;
using Game.Common;
using Game.Entity.system;
using Game.BusinessLogic.SysManage;
using Game.Entity.SysManage;
using Game.PC.WebSecurityHelper;

namespace Game.PC.Areas.SystemModule.Controllers
{
    public class RoleController : MvcControllerBase
    {
        ...
        public ActionResult SaveForm(string keyValue, Sys_Role entity)
        {
            ...
            if (string.IsNullOrWhiteSpace(keyValue))
            {
                ...
                entity.F_CreateUserId = Game.PC.WebSecurityHelper.Passport.Current.UserId.ToString();
            ...
            else
            {
                ...
                entity.F_ModifyUserId = Game.PC.WebSecurityHelper.Passport.Current.UserId.ToString();
