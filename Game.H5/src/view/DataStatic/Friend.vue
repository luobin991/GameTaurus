        ...
        <div class="result"  v-show="hasClick">
            ...
            <div class="hasresult">
                <div class="record" :key="index" v-for="(item,index) in group.arr">
                    ...
                    <div style="flex:1"><span class="title"> 开房数量</span><br/><span>{{item.nTableIDCount}}</span></div>
                    <div style="flex:1"><span class="title"> 玩牌局数</span><br/><span>{{item.nRound}}</span></div>
                    <div style="flex:1"><span class="title"> 下注总额</span><br/><span>{{item.nWinnerTax}}</span></div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadMore() {
                let getData = {
                    params: {
                        'functionname': "GetFriendDataStatis",
                        body: JSON.stringify({
