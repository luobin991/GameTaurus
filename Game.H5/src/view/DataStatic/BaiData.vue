        ...
        <div class="result"   v-show="hasClick">
            ...
            <div class="hasresult">
                <div class="record" :key="index" v-for="(item,index) in group.arr" >
                    ...
                    <div style="flex:1"><span class="title"> 上庄人数</span><br/><span>{{item.nBankIdCount}}</span></div>
                    <div style="flex:1"><span class="title">下注人数</span><br/><span>{{item.nTotalPlayerCount}}</span></div>
                    <div style="flex:1"><span class="title">下注总额</span><br/><span>{{item.nTotalbet}}</span></div>
                </div>
    ...
    export default {
        ...
        methods: {
            ...
            loadMore() {
                let getData = {
                    params: {
                        'functionname': "GetBaiRenDataStatis",
                        body: JSON.stringify({
